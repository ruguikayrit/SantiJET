#!/usr/bin/env bash
# BFA web build for GitHub Pages (/bfa/).
...
# Yalnızca başarılı build sonrası site/bfa yaz.
rm -rf "${SITE_DIR}"
mkdir -p "${SITE_DIR}"
...
echo "URL: https://ruguikayrit.github.io/${REPO_NAME}/bfa/"
