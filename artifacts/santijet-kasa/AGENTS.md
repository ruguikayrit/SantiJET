...
- Hareketler: basılı tut → çoklu seçim → **Taşı** / **Kopyala** hedef şantiyeye.
  Taşı aynı kaydı taşır; kopyala yeni id ile çoğaltır.
...
- Filtre: sıra, gelir/gider, tarih aralığı. Ödeme / belge / tedarikçi chip yok.
