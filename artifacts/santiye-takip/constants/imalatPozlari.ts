...
export const DEFAULT_POZ_ANALIZLERI: PozAnaliz[] = [
  {
    id: "sys-15-250-1114",
    pozNo: "15.250.1114",
    ...
    kalemler: [
      { id: "s1k1", tip: "malzeme", pozNo: "19.100.1100", tanim: "Sıva Makinası (İmalatta kullanılan makina karşılığı)", olcuBirimi: "Sa", miktar: 0.1, birimFiyati: 749.85, tutar: 74.99 },
      { id: "s1k2", tip: "malzeme", pozNo: "10.240.5518", tanim: "Alçı Esaslı Hazır Karışım Zemin Harcı (TS EN 13813)", olcuBirimi: "Kg", miktar: 45, birimFiyati: 2.18, tutar: 98.10 },
      { id: "s1k3", tip: "malzeme", pozNo: "10.130.9991", tanim: "Su", olcuBirimi: "m³", miktar: 0.025, birimFiyati: 55.00, tutar: 1.38 },
      { id: "s1k4", tip: "iscilik", pozNo: "10.100.1068", tanim: "Birinci sınıf usta", olcuBirimi: "Sa", miktar: 0.3, birimFiyati: 310.00, tutar: 93.00 },
      { id: "s1k5", tip: "iscilik", pozNo: "10.100.1062", tanim: "Düz işçi (İnşaat yerinde yükleme, yatay ve düşey taşıma, boşaltma dahil)", olcuBirimi: "Sa", miktar: 0.2, birimFiyati: 205.00, tutar: 41.00 },
    ],
  ...
  },
  {
    id: "sys-04-510-1001",
    pozNo: "04.510/1",
    analizAdi: "Betonarme yapılarda C20/25 beton dökülmesi (hazır beton, pompalı)",
    olcuBirimi: "m³",
    kategori: "Beton ve Demir",
    kaynakTip: "sistem",
    yukleniciKarOrani: 25,
    kalemler: [
      { id: "s2k1", tip: "malzeme", pozNo: "10.400.1010", tanim: "C20/25 Hazır Beton (pompalı)", olcuBirimi: "m³", miktar: 1.05, birimFiyati: 2800.00, tutar: 2940.00 },
      { id: "s2k2", tip: "iscilik", pozNo: "10.100.1068", tanim: "Birinci sınıf usta", olcuBirimi: "Sa", miktar: 0.8, birimFiyati: 310.00, tutar: 248.00 },
      { id: "s2k3", tip: "iscilik", pozNo: "10.100.1062", tanim: "Düz işçi", olcuBirimi: "Sa", miktar: 1.5, birimFiyati: 205.00, tutar: 307.50 },
      { id: "s2k4", tip: "ekipman", pozNo: "19.100.1200", tanim: "Beton pompası (saat başı)", olcuBirimi: "Sa", miktar: 0.15, birimFiyati: 1500.00, tutar: 225.00 },
    ],
    malzemeIscilikToplami: 3720.50,
    yukleniciKarTutari: 930.13,
    birimFiyati: 4650.63,
    pozTarifi: "Betonarme elemanlar için C20/25 sınıfı hazır beton temini, pompaj yöntemiyle dökümü, titreşimli vibratörle sıkıştırılması, yüzeyinin düzeltilmesi ve kürlenmesi dahil 1 m³ fiyatı:",
    yapimSartlari: "Beton dökümü sırasında hava sıcaklığı 5°C'nin altında veya 35°C'nin üzerinde olmamalıdır.",
    olcusu: "Hesap, beton dökülecek elemanın net hacmi üzerinden yapılır.",
    olusturmaTarihi: "2026-01-15T00:00:00.000Z",
    guncellemeTarihi: "2026-01-15T00:00:00.000Z",
  },
  {
    id: "sys-05-010-1001",
    pozNo: "05.010/1",
    analizAdi: "Nervürlü çelik çubuk ile betonarme yapılması (Ø8-Ø16 mm)",
    olcuBirimi: "kg",
    kategori: "Beton ve Demir",
    kaynakTip: "sistem",
    yukleniciKarOrani: 25,
    kalemler: [
      { id: "s3k1", tip: "malzeme", pozNo: "10.500.1010", tanim: "Nervürlü çelik (B420C) Ø8-Ø16 mm", olcuBirimi: "kg", miktar: 1.07, birimFiyati: 28.50, tutar: 30.50 },
      { id: "s3k2", tip: "malzeme", pozNo: "10.500.1200", tanim: "Bağlama teli", olcuBirimi: "kg", miktar: 0.01, birimFiyati: 45.00, tutar: 0.45 },
      { id: "s3k3", tip: "iscilik", pozNo: "10.100.1068", tanim: "Birinci sınıf usta (demirbağ)", olcuBirimi: "Sa", miktar: 0.04, birimFiyati: 310.00, tutar: 12.40 },
      { id: "s3k4", tip: "iscilik", pozNo: "10.100.1062", tanim: "Düz işçi", olcuBirimi: "Sa", miktar: 0.02, birimFiyati: 205.00, tutar: 4.10 },
    ],
    malzemeIscilikToplami: 47.45,
    yukleniciKarTutari: 11.86,
    birimFiyati: 59.31,
    pozTarifi: "Her çap ve profilde nervürlü çelik hasır çubuk temini, kesim, bükme, bağlama ve yerleştirme ile her türlü malzeme ve işçilik dahil 1 kg fiyatı:",
    yapimSartlari: "",
    olcusu: "Hesap teorik ağırlık üzerinden yapılır. Bağlama teli ağırlığı hesaba katılmaz.",
    olusturmaTarihi: "2026-01-15T00:00:00.000Z",
    guncellemeTarihi: "2026-01-15T00:00:00.000Z",
  },
  {
    id: "sys-12-001-0001",
    pozNo: "12.001/1",
    analizAdi: "Dış cephe ısı yalıtımı — 5 cm EPS levha uygulaması",
    olcuBirimi: "m²",
    kategori: "Yalıtım",
    kaynakTip: "sistem",
    yukleniciKarOrani: 25,
    kalemler: [
      { id: "s4k1", tip: "malzeme", pozNo: "10.700.2010", tanim: "EPS 70 Isı Yalıtım Levhası 5 cm", olcuBirimi: "m²", miktar: 1.05, birimFiyati: 185.00, tutar: 194.25 },
      { id: "s4k2", tip: "malzeme", pozNo: "10.700.2100", tanim: "Isı yalıtım yapıştırma harcı", olcuBirimi: "kg", miktar: 6, birimFiyati: 8.50, tutar: 51.00 },
      { id: "s4k3", tip: "malzeme", pozNo: "10.700.2200", tanim: "Plastik dübel", olcuBirimi: "Adet", miktar: 6, birimFiyati: 4.20, tutar: 25.20 },
      { id: "s4k4", tip: "iscilik", pozNo: "10.100.1068", tanim: "Birinci sınıf usta", olcuBirimi: "Sa", miktar: 0.6, birimFiyati: 310.00, tutar: 186.00 },
      { id: "s4k5", tip: "iscilik", pozNo: "10.100.1062", tanim: "Düz işçi", olcuBirimi: "Sa", miktar: 0.4, birimFiyati: 205.00, tutar: 82.00 },
    ],
    malzemeIscilikToplami: 538.45,
    yukleniciKarTutari: 134.61,
    birimFiyati: 673.06,
    pozTarifi: "Dış cephe ısı yalıtımı için EPS levha temini, yapıştırma harcı ile yapıştırılması ve plastik dübel ile sabitlenmesi, her türlü malzeme ve işçilik dahil 1 m² fiyatı:",
    yapimSartlari: "Uygulama yüzeyi kuru, temiz ve düzgün olmalıdır. Yağmur ve don riski olan günlerde uygulama yapılmamalıdır.",
    olcusu: "Uygulama yapılan net alan üzerinden hesaplanır.",
    olusturmaTarihi: "2026-01-15T00:00:00.000Z",
    guncellemeTarihi: "2026-01-15T00:00:00.000Z",
  },
  {
    id: "sys-14-001-0001",
    pozNo: "14.001/1",
    analizAdi: "Saten alçı ile iç yüzey sıvası (2 kat)",
    olcuBirimi: "m²",
    kategori: "Sıva ve Şap",
    kaynakTip: "sistem",
    yukleniciKarOrani: 25,
    kalemler: [
      { id: "s5k1", tip: "malzeme", pozNo: "10.240.1010", tanim: "Saten Alçı (hazır)", olcuBirimi: "kg", miktar: 3.5, birimFiyati: 6.80, tutar: 23.80 },
      { id: "s5k2", tip: "malzeme", pozNo: "10.130.9991", tanim: "Su", olcuBirimi: "m³", miktar: 0.002, birimFiyati: 55.00, tutar: 0.11 },
      { id: "s5k3", tip: "iscilik", pozNo: "10.100.1068", tanim: "Birinci sınıf usta", olcuBirimi: "Sa", miktar: 0.5, birimFiyati: 310.00, tutar: 155.00 },
      { id: "s5k4", tip: "iscilik", pozNo: "10.100.1062", tanim: "Düz işçi", olcuBirimi: "Sa", miktar: 0.25, birimFiyati: 205.00, tutar: 51.25 },
    ],
    malzemeIscilikToplami: 230.16,
    yukleniciKarTutari: 57.54,
    birimFiyati: 287.70,
    pozTarifi: "İç yüzeylere 2 kat saten alçı sıvasının uygulanması, kuruması beklenerek zımparalanması, her türlü malzeme ve işçilik dahil 1 m² fiyatı:",
    yapimSartlari: "",
    olcusu: "Sıva uygulanan net yüzey alanı üzerinden hesaplanır.",
    olusturmaTarihi: "2026-01-15T00:00:00.000Z",
    guncellemeTarihi: "2026-01-15T00:00:00.000Z",
  },
  {
    id: "sys-16-100-0001",
    pozNo: "16.100/1",
    analizAdi: "Seramik yer kaplaması (30x30 cm)",
    olcuBirimi: "m²",
    kategori: "Kaplama",
    kaynakTip: "sistem",
    yukleniciKarOrani: 25,
    kalemler: [
      { id: "s6k1", tip: "malzeme", pozNo: "10.300.1010", tanim: "Seramik yer karosi 30x30 cm (1. sınıf)", olcuBirimi: "m²", miktar: 1.05, birimFiyati: 320.00, tutar: 336.00 },
      { id: "s6k2", tip: "malzeme", pozNo: "10.300.1100", tanim: "Fayans yapıştırma harcı (C1)", olcuBirimi: "kg", miktar: 5, birimFiyati: 9.50, tutar: 47.50 },
      { id: "s6k3", tip: "malzeme", pozNo: "10.300.1200", tanim: "Derz dolgu malzemesi", olcuBirimi: "kg", miktar: 0.5, birimFiyati: 22.00, tutar: 11.00 },
      { id: "s6k4", tip: "iscilik", pozNo: "10.100.1068", tanim: "Birinci sınıf usta (karolayıcı)", olcuBirimi: "Sa", miktar: 0.9, birimFiyati: 310.00, tutar: 279.00 },
      { id: "s6k5", tip: "iscilik", pozNo: "10.100.1062", tanim: "Düz işçi", olcuBirimi: "Sa", miktar: 0.45, birimFiyati: 205.00, tutar: 92.25 },
    ],
    malzemeIscilikToplami: 765.75,
    yukleniciKarTutari: 191.44,
    birimFiyati: 957.19,
    pozTarifi: "Hazır altta şap yapılmış zemine seramik yer karosunun yapıştırma harcı ile döşenmesi, derzlerinin doldurulması, her türlü malzeme ve işçilik dahil 1 m² fiyatı:",
    yapimSartlari: "Şap yüzeyi düzgün, temiz ve kuru olmalıdır.",
    olcusu: "Kaplama yapılan net alan üzerinden hesaplanır.",
    olusturmaTarihi: "2026-01-15T00:00:00.000Z",
    guncellemeTarihi: "2026-01-15T00:00:00.000Z",
  },
];
