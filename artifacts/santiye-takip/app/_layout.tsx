  ...
  return (
    <AppGate>
      <Stack screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="satin-alma" />
        <Stack.Screen name="kantar" />
        ...
        <Stack.Screen name="yybm" />
        <Stack.Screen name="meslekler" />
        <Stack.Screen name="meslek-grubu" />
        <Stack.Screen name="dosyalar" />
      </Stack>
    </AppGate>
  );
}
