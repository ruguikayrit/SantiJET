...
/// ŞantiJET PRO açılış — Puantaj splash deseni, ürün etiketi PRO.
...
class _SplashScreenState extends ConsumerState<SplashScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: BrandSplash.darkCanvas,
      body: ColoredBox(
        color: BrandSplash.darkCanvas,
        child: Stack(
          fit: StackFit.expand,
          children: [
            Positioned.fill(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: const LinearGradient(
                                colors: [
                                  BrandSplash.electricBlue,
                                  BrandSplash.electricBlueLight,
                                ],
                              ),
                            ),
                          ),
...
class _BlueprintGridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = BrandSplash.blueprintGrid
      ..strokeWidth = 0.5;
