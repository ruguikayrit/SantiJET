...
class DemoSeedController {
  ...
  void _replaceProductions({required String projectId}) {
    ...
    void add({
      ...
      production.add(
        Production(
          ...
          section: section,
          teamName: teamName,
          workGroup: ProductionWorkGroupCatalog.normalize(
            workGroup.isEmpty
                ? ProductionWorkGroupCatalog.inferFromTeamName(teamName)
                : workGroup,
          ),
          unit: unit,
    ...
    add(
      ...
      section: '1. Kısım',
      teamName: 'Demir',
      workGroup: TaskTagCatalog.insaat,
      unit: 'ton',
      plannedQty: 20,
      plannedDays: 7,
      plannedLabor: 6,
    ...
    add(
      ...
      section: 'Koridor',
      teamName: 'Aydınlatma',
      workGroup: TaskTagCatalog.elektrik,
      unit: 'm',
      plannedQty: 420,
      plannedDays: 8,
      plannedLabor: 3,
    ...
    add(
      ...
      teamName: 'Havalandırma',
      workGroup: TaskTagCatalog.mekanik,
      unit: 'm',
      plannedQty: 260,
      plannedDays: 9,
      plannedLabor: 4,
      ...
      reports.upsert(
        DailyReport(
          ...
          planConstruction: switch (i % 3) {
            ...
            1 => 'Alçı sıva 2. kısım.\nEpoksi öncesi yüzey temizliği.',
            _ => 'Kiriş demiri kontrol.\nAsansör boşluğu kalıp sökümü.',
          },
          planElectrical: switch (i % 2) {
            0 => 'Zemin kat aydınlatma hattı ${i + 1}.\nPano bağlantı kontrolü.',
            _ => 'Bodrum koridor armatür montajı.',
          },
          planMechanical: i.isEven
              ? 'Havalandırma kanalı montaj devam.\nKlima santrali bağlantı.'
              : 'SPRİ kanal tedarik takibi.',
          incomingMaterials: [
            DailyReportMaterial(
              id: IdGen.make('mat'),
