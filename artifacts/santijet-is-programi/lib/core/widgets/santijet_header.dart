...
/// ŞantiJET marka başlığı — Ayarlar sağ üst dişli; zil/avatar yok.
class SantijetHeader extends StatelessWidget {
  const SantijetHeader({super.key, this.subtitle, this.showWordmark = false});
...
TextStyle get _brandMetricStyle =>
    _productMetricBaseStyle.copyWith(fontSize: AppTypography.brandScale * 14);
...
abstract final class _BrandTitleMetrics {
  ...
  static double productIndentOf(BuildContext context) {
    ...
    final leftInk = isLight ? _lightWordmarkLeftInkPx : _darkWordmarkLeftInkPx;
    final pixelHeight = isLight
        ? _lightWordmarkPixelHeight
        : _darkWordmarkPixelHeight;
